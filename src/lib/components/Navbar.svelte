<!-- cuerpo -->
<nav class="flex justify-between p-0 px-6 border-b-[1px] border-global-veryLigthPink">
	...
	<div class="flex justify-center items-center">
		...
		<ul class="list-style p-0 m-0 flex items-center h-[60px] ml-3 max-[767px]:hidden">
			<li>
				<a
					class="text-global-veryLigthPink border-[1px] border-white p-2 rounded-lg hover:border-[1px] hover:border-global-hospitalGreen hover:text-global-hospitalGreen"
					href="/">Todos</a
				>
			</li>
			<li>
